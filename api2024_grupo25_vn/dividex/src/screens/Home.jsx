...
import { obtenerProyectos, obtenerDeudasUsuario, obtenerGastosUsuario, obtenerDeudasAmigos } from '../components/CalculosHome'; // Importar funciones
import { getTickets, getExpenseDetails } from '../services/ticketService'; // Agregar importación de getTickets y getExpenseDetails
import '../css/Home.css';
...
const Inicio = () => {
  ...
  const [gastosPorMiembro, setGastosPorMiembro] = useState([]);
  ...
  useEffect(() => {
    ...
    const cargarDatosFinancieros = async () => {
      ...
      const gastosDetalles = tickets.map(ticket => getExpenseDetails(ticket));
      setGastosPorMiembro(gastosDetalles);
    };
